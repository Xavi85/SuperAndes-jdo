...
//			e.printStackTrace();
    	...
    	try
		{
			...
			VOTipoBebida tipoBebida1 = SuperAndes.adicionarTipoBebida (nombreTipoBebida1);
			lista = SuperAndes.darVOTiposBebida();
			...
			VOTipoBebida tipoBebida2 = SuperAndes.adicionarTipoBebida (nombreTipoBebida2);
			lista = SuperAndes.darVOTiposBebida();
			...
			long tbEliminados = SuperAndes.eliminarTipoBebidaPorId (tipoBebida1.getId ());
			...
			// Prueba de eliminación de un tipo de bebida, dado su identificador
			tbEliminados = SuperAndes.eliminarTipoBebidaPorNombre (nombreTipoBebida2);
			assertEquals ("Debe haberse eliminado un tipo de bebida !!", 1, tbEliminados);
			lista = SuperAndes.darVOTiposBebida();
...
//			e.printStackTrace();
		...
		try
		{
			...
			VOTipoBebida tipoBebida2 = SuperAndes.adicionarTipoBebida (nombreTipoBebida1);
