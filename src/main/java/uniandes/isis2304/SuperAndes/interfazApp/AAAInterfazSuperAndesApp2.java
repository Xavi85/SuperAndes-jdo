...
public class AAAInterfazSuperAndesApp2
{
	/* ****************************************************************
	 * 			Constantes
	 *****************************************************************/
	 ...
	 *//*
	private static Logger log = Logger.getLogger(AAAInterfazSuperAndesApp2.class.getName());
     ...
     *//*
    public AAAInterfazSuperAndesApp2( )
    {
...
//			e.printStackTrace ();
    ...
    public void adicionarTipoBebida( )
    {
    	try 
    	{
    		...
    		if (nombreTipo != null)
    		{
        		VOTipoBebida tb = SuperAndes.adicionarTipoBebida (nombreTipo);
        		if (tb == null)
        		{
...
//			e.printStackTrace();
    ...
    public void listarTipoBebida( )
    {
    	try 
    	{
			List <VOTipoBebida> lista = SuperAndes.darVOTiposBebida();
    ...
    public void eliminarTipoBebidaPorId( )
    {
    	try 
    	{
    		...
    		if (idTipoStr != null)
    		{
    			...
    			long tbEliminados = SuperAndes.eliminarTipoBebidaPorId (idTipo);
...
//			e.printStackTrace();
    ...
    public void buscarTipoBebidaPorNombre( )
    {
    	try 
    	{
    		...
    		if (nombreTb != null)
    		{
    			VOTipoBebida tipoBebida = SuperAndes.darTipoBebidaPorNombre (nombreTb);
...
//			e.printStackTrace();
	...
	public void actionPerformed(ActionEvent pEvento)
	{
        ...
        try 
        {
			Method req = AAAInterfazSuperAndesApp2.class.getMethod ( evento );			
			req.invoke ( this );
		} 
        catch (Exception e) 
        {
    ...
    public static void main( String[] args )
    {
        try
        {
            ...
            AAAInterfazSuperAndesApp2 interfaz = new AAAInterfazSuperAndesApp2( );
